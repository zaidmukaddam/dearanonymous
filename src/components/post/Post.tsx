    ...
    <div className={styles.Post}>
      <div className={styles.PostHeader}>
        <div className={styles.NumberAndWarning}>
          ...
          {props.post.verifiedNMIMS && (
            <RiShieldCheckFill
              className={styles.verifiedNMIMS}
              title="Verified NMIMS"
            />
          )}
            ...
            if (navigator.share) {
              navigator
                .share({
                  ...
                  url: `https://dearanonymous.space/post/${props.post.postNumber}`,
                })
                .catch((err) => {
                  console.error(err);
                });
              ...
              navigator.clipboard
                .writeText(
                  `https://dearanonymous.space/post/${props.post.postNumber}`
                )
                .catch((err) => {
                  console.error(err);
                });
