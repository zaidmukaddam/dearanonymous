  ...
  return (
    <>
      <p className="PrivSection">
        {`The developers of dearanonymous.space ("we", "us", "our") are committed
              ...
              for anyone, even the developers of dearanonymous.space, to know who the
              original poster is.`}
      </p>
      <p className="PrivSection">
      ...
      <p className="PrivSection">
        ...
        dearanonymous.space are stored on Imgur, and then are embedded on our site.
      ...
      <p className="PrivSection">
        All data needed to operate dearanonymous.space, as described above, is stored
      ...
      <p className="PrivSection">
        ...
        <a
          href="https://github.com/zaidmukaddam/dearanonymous"
          target="_blank"
          rel="noopener noreferrer"
        >
