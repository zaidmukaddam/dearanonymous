...
export default function ImageUpload(props: ImageUploadProps) {
  ...
  const onFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setUploading(true);
    fetch(`https://api.imgur.com/3/image?client_id=${process.env.NEXT_PUBLIC_IMGUR_CLIENT_ID ?? "43af659a5997680"}`, {
      method: "POST",
      headers: {
        Authorization: `Client-ID ${process.env.NEXT_PUBLIC_IMGUR_CLIENT_ID ?? "43af659a5997680"}`,
      },
      body: formData,
    })
      .then((res) => {
