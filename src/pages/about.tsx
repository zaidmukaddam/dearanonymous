...
const AboutPage: NextPage = () => {
  return (
    <>
      <Head>
        <title>About - Dear Anonymous</title>
      </Head>
    ...
    <div className={styles.AboutPagePost}>
      ...
      <div className={styles.AboutPageSection}>
        ...
        <div className="Accordion">
          ...
          >
            <div className={styles.FAQAnswer}>
              <p>
                ...
                NMIMS email. If so, the post is deemed {'"verified" '}
          ...
          <Collapsible
            trigger="Is this related to the MPSTME Confessions Instagram Page?"
            triggerClassName={styles.FAQQuestion}
            triggerOpenedClassName={
              styles.FAQQuestion + " " + styles["is-open"]
            }
      ...
      <div className={styles.AboutPageSection}>
        ...
        <p>
          ...
          <a
            href="mailto:developers@dearanonymous.space"
            className={styles.EmailLink}
          >
            developers@dearanonymous.space
          </a>
          .
        </p>
      </div>
